...
<div class="header-top-right float-right">
	...
	if ($logged == "1") {
       ...
       <a href="logout.php" class="header-top-button"><i class="lni-enter"></i> Log Out</a>
       <?php
...
<div class="post-btn">
    <?php
	if ($logged == "1") {
		print '<a class="btn btn-common" href="'.$myrole.'/upload.php"><i class="lni-pencil-alt"></i> Post an Ad</a>';

		}else{

		print '<a class="btn btn-common" href="login.php"><i class="lni-lock"></i> Login to Post</a>';
